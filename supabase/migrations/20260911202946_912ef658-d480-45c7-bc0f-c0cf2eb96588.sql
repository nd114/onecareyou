CREATE OR REPLACE FUNCTION public.seed_demo_vault_documents()
RETURNS integer
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE ALL ON FUNCTION public.seed_demo_vault_documents() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.seed_demo_vault_documents() FROM anon, authenticated;
GRANT EXECUTE ON FUNCTION public.seed_demo_vault_documents() TO service_role;

SELECT public.seed_demo_vault_documents();