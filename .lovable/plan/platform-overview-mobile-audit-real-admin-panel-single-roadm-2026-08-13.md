...
- Fold in and archive: `ai-implementation-roadmap.md`, `clinician-gaps-implementation-plan.md`, `clinician-strategic-roadmap.md`, `implementation-tracking.md`, `requirements-implemented.md`, `comprehensive-platform-review.md`, `qa-report-jul-2026.md`, `ui-redesign-plan.md`, `tech-and-process-opportunities.md`, `launch-plan.md`.
