      ...
      <section className="py-16 bg-background">
        <div className="container max-w-4xl">
          ...
          >
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    While we strive to provide accurate and up-to-date information about drug interactions, our database
                    may not include all possible interactions.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>
                      Interaction information is sourced from FDA databases (DailyMed, OpenFDA, RxNorm) and may not
                    ...
                    <li>
                      Interactions may differ based on dosage, timing, individual health conditions, and other factors
                    </li>
                  </ul>
                  <p className="text-muted-foreground mt-4 font-semibold">
                    Always consult a pharmacist or physician to verify drug interactions before starting, stopping, or
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>
                      <strong>Always verify</strong> AI-extracted values against your original lab reports
                    </li>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Medication reminders are provided as a convenience tool and should not be relied upon as your sole
                    method of medication management.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>
                      Technical issues, device settings, or connectivity problems may prevent reminders from being
                      delivered
                    </li>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-4">
                    However, errors may occur, and medical knowledge evolves rapidly. We cannot guarantee that all
            ...
            {/* Last Updated */}
            <p className="text-sm text-muted-foreground text-center">Last updated: January 17, 2026</p>
