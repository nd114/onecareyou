            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { feature: 'Adherence Reports', solo: true, pro: true, enterprise: true },
                  { feature: 'Guidance Templates', solo: false, pro: true, enterprise: true },
                  { feature: 'Analytics Dashboard', solo: 'Basic', pro: 'Advanced', enterprise: 'Advanced' },
                  { feature: 'Team Members', solo: false, pro: 'Coming soon', enterprise: 'Unlimited' },
                  { feature: 'EHR/FHIR Integration', solo: false, pro: false, enterprise: true },
                  { feature: 'API Access', solo: false, pro: false, enterprise: true },
