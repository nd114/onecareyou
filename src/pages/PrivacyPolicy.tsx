              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Provide Core Services:</strong> Track medications, record vitals, send reminders, and
                      manage your health data
                    </li>
                    <li>
                      <strong>Process Documents:</strong> Extract data from uploaded lab reports (with your explicit
                      consent for AI processing)
                    </li>
                    <li>
                      <strong>Send Notifications:</strong> Medication reminders, refill alerts, care alerts, and system
                      notifications
                    </li>
                    <li>
                      <strong>Enable Provider Sharing:</strong> Allow you to share your health data with healthcare
                      providers you designate
                    </li>
                    <li>
                      <strong>Improve Services:</strong> Analyze usage patterns to enhance features and user experience
                    </li>
                    <li>
                      <strong>Customer Support:</strong> Respond to inquiries and resolve issues
                    </li>
                    <li>
                      <strong>Security:</strong> Detect, prevent, and address fraud, abuse, and security issues
                    </li>
                    <li>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <Separator className="my-4" />
                  <p>
                    <strong>Audit Trail:</strong> All consent changes are logged with timestamps, IP addresses, and user
                    agent information for your records and legal compliance.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>With Your Consent:</strong> When you explicitly choose to share data with healthcare
                      providers through our provider sharing feature
                    </li>
                    <li>
                      <strong>Care Alerts:</strong> When you configure care alerts, we send notifications to your
                      designated contacts about missed medications
                    </li>
                    <li>
                      <strong>Service Providers:</strong> With third-party vendors who assist in operating our Service
                      (hosting, email, analytics), under strict confidentiality agreements
                    </li>
                    <li>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>You Control Access:</strong> You initiate all provider shares and can revoke access at any
                      time
                    </li>
                    <li>
                      <strong>Granular Permissions:</strong> You choose what data types to share (vitals, medications,
                      adherence, profile)
                    </li>
                    <li>
                      <strong>Access Logging:</strong> We log when providers access your data
                    </li>
                    <li>
                      <strong>Expiration:</strong> You can set expiration dates for provider access
                    </li>
                    <li>
                      <strong>Provider Responsibilities:</strong> Healthcare providers who access your data are
                      responsible for maintaining confidentiality according to their professional obligations and
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    ...
                    including GDPR (EU), CCPA (California, USA), POPIA (South Africa), PIPEDA (Canada), and other
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      <strong>Withdraw Consent:</strong> Revoke AI processing consent or other consents at any time
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Non-Discrimination:</strong> We will not discriminate against you for exercising your
                      privacy rights
                    </li>
                  </ul>
                  <Separator className="my-4" />
                  <p>
                    <strong>Jurisdiction-Specific Rights:</strong>
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>South Africa (POPIA):</strong> You have the right to object to processing, request
                      correction or deletion of personal information, and lodge complaints with the Information
                      Regulator
                    </li>
                    <li>
                      <strong>Canada (PIPEDA):</strong> You may access your personal information, challenge its
                      accuracy, and withdraw consent (subject to legal or contractual restrictions)
                    </li>
                    <li>
                      <strong>European Union (GDPR):</strong> You have rights to data portability, restriction of
                      processing, and to lodge complaints with your local supervisory authority
                    </li>
                    <li>
                      <strong>California (CCPA/CPRA):</strong> You have the right to know, delete, opt-out of
                      sale/sharing, and non-discrimination for exercising your rights
                    </li>
                  </ul>
                  <Separator className="my-4" />
                  <p>
                  ...
                  <p>
                    <strong>Verification:</strong> We may need to verify your identity before processing certain
                    requests.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Encryption in Transit:</strong> All data is encrypted using TLS 1.3 during transmission
                    </li>
                    <li>
                      <strong>Encryption at Rest:</strong> Data is encrypted using AES-256 when stored
                    </li>
                    <li>
                      <strong>Access Controls:</strong> Strict authentication and authorization requirements
                    </li>
                    <li>
                      <strong>Row-Level Security:</strong> Database-level controls ensure you only access your own data
                    </li>
                    <li>
                      <strong>Regular Audits:</strong> Security audits and vulnerability assessments
                    </li>
                    <li>
                      <strong>Secure Infrastructure:</strong> Data stored in SOC 2 Type II compliant cloud
                      infrastructure
                    </li>
                    <li>
                      <strong>Password Protection:</strong> Passwords are hashed using industry-standard algorithms and
                      checked against known breach databases
                    </li>
                    <li>
                      <strong>Session Security:</strong> Automatic session expiration and secure token management
                    </li>
                  </ul>
                  <Separator className="my-4" />
                  <p>
                    <strong>Data Location:</strong> Your data is primarily stored in data centers located in the United
                    States. If you access the Service from outside the US, your data may be transferred to the US.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      <strong>Account Deletion:</strong> Upon account deletion, we will delete or anonymize your data
                      within 30 days, except as required by law
                    </li>
                    <li>
                      <strong>Legal Retention:</strong> Some data may be retained longer to comply with legal
                      obligations, resolve disputes, or enforce agreements
                    </li>
                    <li>
                      <strong>Backups:</strong> Backup copies may persist for up to 90 days after deletion
                    </li>
                    <li>
                      <strong>Audit Logs:</strong> Consent and access logs may be retained for up to 7 years for legal
                      compliance
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Essential Cookies:</strong> Required for authentication, security, and basic functionality
                    </li>
                    <li>
                      <strong>Preference Cookies:</strong> Remember your settings and preferences
                    </li>
                    <li>
                      <strong>Analytics Cookies:</strong> Understand how you use our Service to improve it
                    </li>
                  </ul>
                  <p>
                    We do not use advertising or marketing tracking cookies. You can control cookie preferences through
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <p>
                    ...
                    information for their minor children through the family member feature. This data is managed under
                    the parent/guardian's account and subject to this Privacy Policy.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <p>
                    By using our Service, you consent to such transfers. We take steps to ensure that your data is
                    treated securely and in accordance with this Privacy Policy, regardless of where it is processed.
                  </p>
                  <p>
                    For EU/EEA users: We rely on Standard Contractual Clauses and other appropriate safeguards for
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p>
                      For users in South Africa, we comply with the Protection of Personal Information Act. Your
                      personal information is processed lawfully, and you have the right to access, correct, or delete
                      your data. Complaints may be directed to the Information Regulator.
                    </p>
                  </div>
                  <Separator />
                  <div>
                    ...
                    <p>
                      ...
                      Act. We obtain meaningful consent for collection, use, and disclosure of personal information. You
                      may withdraw consent at any time, subject to legal restrictions.
                    </p>
                  </div>
                  <Separator />
                  <div>
                    ...
                    <p>
                      For users in the EU/EEA, we process personal data in accordance with the General Data Protection
                      Regulation. Our lawful basis for processing includes consent (for AI features) and legitimate
                      interests (for service provision). Data transfers outside the EU are protected by Standard
                      Contractual Clauses.
                    </p>
                  </div>
                  <Separator />
