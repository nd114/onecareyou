...
export const EHR_PROVIDERS = [
  { id: 'veradigm', name: 'Veradigm', description: 'Connect via SMART on FHIR', available: true },
  { id: 'athenahealth', name: 'athenahealth', description: 'Connect via SMART on FHIR', available: true },
